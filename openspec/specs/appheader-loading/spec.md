# AppHeader Loading Specification

## Purpose
Provides loading progress feedback in the shared AppHeader component and establishes screen-level header ownership for photo feed screens.
