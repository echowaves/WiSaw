...
When `onEndReached` fires during horizontal scrolling and photos are successfully fetched and appended, the strip SHALL auto-scroll to the end to maintain the user in the "load more" zone.
