# Preference Storage Migration Specification

## Purpose
Defines the storage strategy for user preferences, separating non-sensitive preferences (filesystem via expo-storage) from sensitive identity data (Keychain via expo-secure-store).
