# Wave Header Icon Specification

## Purpose
The wave header icon provides quick access to the Waves Hub from the main photo feed header, with visual indication of the current upload target wave status.
