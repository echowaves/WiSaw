...
#### Scenario: Phase 2 resets accuracy gate
- **WHEN** Phase 2 starts
- **THEN** the accuracy gate SHALL be reset to allow all fixes (storedAccuracyRef set to Infinity)
- **THEN** this ensures fresh GPS fixes always replace stale cached positions regardless of the seed's accuracy value
