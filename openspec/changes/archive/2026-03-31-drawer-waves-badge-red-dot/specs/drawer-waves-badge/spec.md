...
**Reason**: The badge no longer displays a numeric count; it is now a simple red dot.
**Migration**: No migration needed. The `badgeText` computation is removed from the component.
