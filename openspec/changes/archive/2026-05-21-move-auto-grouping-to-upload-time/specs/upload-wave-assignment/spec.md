...
### Requirement: Capture-time drift check
- **Reason**: Moved to upload time in this change
- **Migration**: Wave assignment now happens in `processCompleteUpload()` instead of `useCameraCapture.js`
