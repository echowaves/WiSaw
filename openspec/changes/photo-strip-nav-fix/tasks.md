...
- [ ] 1.9 Test: Click on a photo in a friend card's photo strip
- [ ] 1.9 Verify: FriendDetail screen loads and shows photos from that friend
- [ ] 1.9 Test: Click on a photo in a wave card's photo strip
- [ ] 1.10 Verify: WaveDetail screen loads and shows photos from that wave
- [ ] 1.11 Test: Click on a friend card (not photo strip) to verify info area navigation still works
- [ ] 1.12 Test: Friend with no photos shows correct empty state with "No Photos Yet"
