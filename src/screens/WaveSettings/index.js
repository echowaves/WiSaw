...
const WaveSettings = ({ waveUuid, waveName }) => {
  ...
  const handleToggleOpen = async (value) => {
    ...
    try {
      ...
      setIsOpen(value)
      showSuccessToast(value ? 'Wave is now open' : 'Wave is now invite-only')
    } catch (error) {
  ...
  const handleSplashDateChange = async (_event, selectedDate) => {
    if (selectedDate) {
      ...
      try {
        ...
        showSuccessToast('Splash date updated')
      } catch (error) {
  ...
  const handleFreezeDateChange = async (_event, selectedDate) => {
    if (selectedDate) {
      ...
      try {
        ...
        showSuccessToast('Freeze date updated')
      } catch (error) {
  ...
  const clearSplashDate = async () => {
    ...
    try {
      ...
      setSplashDate(null)
      showSuccessToast('Splash date cleared')
    } catch (error) {
  ...
  const clearFreezeDate = async () => {
    ...
    try {
      ...
      setFreezeDate(null)
      setIsFrozen(result.isFrozen === true)
      showSuccessToast('Freeze date cleared')
    } catch (error) {
  ...
  const handleSetSplashDate = async () => {
    ...
    try {
      ...
      setSplashDate(today)
      showSuccessToast('Splash date set')
    } catch (error) {
  ...
  const handleSetFreezeDate = async () => {
    ...
    try {
      ...
      setFreezeDate(today)
      setIsFrozen(result.isFrozen === true)
      showSuccessToast('Freeze date set')
    } catch (error) {
  ...
  const handleFreezeModeChange = async (mode) => {
    ...
    try {
      ...
      setFreezeMode(mode)
      setIsFrozen(result.isFrozen === true)
      showSuccessToast(`Freeze mode set to ${mode === 'AUTO' ? 'Auto' : mode === 'FROZEN' ? 'Frozen' : 'Unlocked'}`)
    } catch (error) {
  ...
  const handleRadiusSave = async (value) => {
    ...
    try {
      ...
      showSuccessToast(`Radius set to ${value} mi`)
    } catch (error) {
